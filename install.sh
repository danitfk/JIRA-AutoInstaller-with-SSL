...
### Generate response.varfile
function generate_varfile {
cat > /tmp/jira-core_response.varfile << EOL
#install4j response file for JIRA Core 7.12.3
#Sat Nov 17 15:21:29 UTC 2018
#Generated by script
...
### Download and Install JIRA-CORE\
function install_jira_core {
wget -O jira-core.bin "$JIRA_CORE_URL"
